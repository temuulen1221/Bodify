...
export default function Shop() {
  ...
  return (
    <LinearGradient colors={['#0B1120', '#1B2339', '#3A3D53']} style={styles.container}>
...
const styles = StyleSheet.create({
  container: {
    ...
    pointsRow: {
      ...
      marginBottom: 14,
      backgroundColor: 'rgba(18,217,255,0.06)',
      borderRadius: 12,
    ...
    tabBtnActive: {
      backgroundColor: 'rgba(18,217,255,0.14)',
      borderColor: 'rgba(18,217,255,0.28)',
    },
    tabBtnTextActive: {
      color: '#F8FBFF',
    },
